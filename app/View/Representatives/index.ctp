...
<h3>                        You can search any New Jersey assembly member's name to find that assembly member. Each assembly member  has a picture, their name, the year they were elected, their political affiliation, and district number.
		...
		<!--These are the filters in which the user can make an advanced search by typing the name, party, year elected, or district name of the Assembly member they are looking for.-->	
                <label class="filterLabel">Filters:</label><br>
		<a href = "http://www.njleg.state.nj.us/"><label class="filterLabel">Name</label><input class="filter" type="input"></a><br>
		...
		<!--This allows the user to select how many Assembly members they would like to view per page-->
		    Items per Page:
